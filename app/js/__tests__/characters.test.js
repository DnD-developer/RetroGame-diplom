...
describe("Scion of Character", () => {
	test.each([
		[Bowman, { level: 1, type: "bowman", health: 50, attack: 25, defence: 25, move: 2, lengthAttack: 2 }],
		[Swordsman, { level: 1, type: "swordsman", health: 50, attack: 40, defence: 10, move: 4, lengthAttack: 1 }],
		[Magician, { level: 1, type: "magician", health: 50, attack: 10, defence: 40, move: 1, lengthAttack: 4 }],
